...
=== part2ish ===
    ...
    [BOOTH] Paige: 너 지금... 게임 페스티벌에서 지원서 넣은 거니?
    [BOOTH] Ian: 우와, 너 정말 부럽다!
    [BOOTH] Paige: 뭐 어디에 있든 간에...
    [DESKTOP] Paige: ... <color=#ff0000>일곱 번째</color> 박자에 맞춰서 스페이스 바를 눌러 환자를 도와주면 돼.
    [NX] Paige: ... <color=#ff0000>일곱 번째</color> 박자에 맞춰 ZL/ZR 버튼을 눌러 환자를 도와주면 돼.
...
=== tutorial1Miss ===
    DOTHIS {setDialogueType(Passive)}
    Paige: 아깝네.
    [DESKTOP] Ian: 스페이스 바를 강하게 눌러보는 건 어때?
    [DESKTOP] Ian: 소리도 들어봐. 
    [DESKTOP] Ian: 박자를 셀 때 도움이 될 거야!
-> END
...
//need to add switch specific
//
=== tutorial1NoInput ===
    DOTHIS {setDialogueType(Passive)}
    Paige: 이런.
    [DESKTOP] Paige: 일곱 번째 박자에 스페이스 바를 눌러.
    [NX] Paige: 일곱 번째 박자에 ZL/ZR 버튼을 누르세요
-> END
